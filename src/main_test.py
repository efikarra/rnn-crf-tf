...
if __name__ == '__main__':
    ...
    params.train_input_path = '../data/train_word_seq.txt'
    params.train_target_path = '../data/train_label_seq.txt'
    # Validation data files.
    # params.val_input_path='experiments/data/example_input.txt'
    # params.val_target_path='experiments/data/example_target.txt'
    params.val_input_path = '../data/dev_word_seq.txt'
    params.val_target_path = '../data/dev_label_seq.txt'
    ...
    params.input_emb_file = '../data/embedding.txt'
    ...
    params.vocab_path = '../data/train_vocab.txt'

    # Checking if new embeddings need to be created
    params.create_new_embeddings = False
    params.embedding_path = '../data/embeddings/glove.840B.300d.txt'
    ...
    # params.eval_output_folder = '../results'
    ...
    params.eval_input_path = '../data/test_word_seq.txt'
    params.eval_target_path = '../data/test_label_seq.txt'
